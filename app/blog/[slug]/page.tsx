...
const BASE_URL = "https://flynth.com.ng";

// ─── SEO: generateMetadata (App Router) ───────────────────────────────────────
export async function generateMetadata(
  ...
  if (!post) {
    return {
      title: "Post Not Found | Flynth Technologies",
    };
  }
  ...
  return {
    ...
    openGraph: {
      ...
      authors: ["Flynth Technologies"],
      tags: [post.category],
      images: [{ url: "https://flynth.com.ng/images/og-blog.png", width: 1200, height: 630, alt: `${post.title} — Flynth Technologies` }],
    },
    twitter: {
                ...
                dangerouslySetInnerHTML={{
                    __html: JSON.stringify({
                        ...
                        "publisher": {
                            ...
                            "logo": {
                                "@type": "ImageObject",
                                "url": "https://flynth.com.ng/favicon.svg",
                            },
                        },
                        ...
                        "mainEntityOfPage": {
                            "@type": "WebPage",
                            "@id": `https://flynth.com.ng/blog/${post!.slug}`,
                        },
                        "url": `https://flynth.com.ng/blog/${post!.slug}`,
